#include <vector>
#include "VolumeDicomFormat.h"

bool VolumeDicomFormat::load(const std::string& filename) {
...
bool VolumeDicomFormat::save(const std::string& filename) {
...
std::string VolumeDicomFormat::getMetadata() const {
...
std::vector<int> VolumeDicomFormat::getPixelValues() const {
    DcmDataset* dataset = fileFormat.getDataset();
